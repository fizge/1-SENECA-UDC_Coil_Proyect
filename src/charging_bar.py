...
class ChargingWindow:
    ...
    def bar(self):
        ...
        label = ctk.CTkLabel(self.charging_window, text="Loading... Please wait", font=("Arial", 17,"bold"))
        label.pack(pady=20)

        progress_bar = ctk.CTkProgressBar(self.charging_window, mode='indeterminate')
